...
<xsl:template match="d:procedure">
  ...
  <xsl:variable name="preamble"
        select="*[not(self::d:step
                ...
                |processing-instruction()[not(preceding-sibling::d:step)]"/> <!-- Anpassung by T. Meinike 04/22: neu: or self::d:result -->
  ...
  <xsl:apply-templates select="d:result"/> <!-- Anpassung by T. Meinike 04/22: neue Zeile -->
</xsl:template>
